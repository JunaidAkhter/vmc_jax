...
D = 10
net_init = MyNet(num_nodes = 2, inp_dims = (4,3), oup_dims = (6,6), D = D) 
...
np.savetxt('cpxmpo_12_avg_d10_43_sr', E_0_aarray, header='Data for cpxmpo with D = 10 for 5 different initializations')
