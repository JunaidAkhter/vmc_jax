...
def simulate(rng, iterations, D, t_step = 1e-2): #Original t = 1e-2
...
np.savetxt('cpxmpo_12_avg_d10_43_sr_1t', E_0_aarray, header='Data for rlmpo with D = 10 for 5 initializations')
