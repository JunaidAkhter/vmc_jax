...
D = 3 # should be 3.2 for \alpha = 1
net_init = MyNet(num_nodes = 2, inp_dims = (2,4), oup_dims = (2,4), D = D) 
...
np.savetxt('cpxmpo_8_avg_d3_24_gs', E_0_aarray, header='Data for rlmpo with D = 3 for 3 different initializations')
