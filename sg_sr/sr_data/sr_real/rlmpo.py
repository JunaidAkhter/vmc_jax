...
def simulate(rng, iterations, D):
    net = MyNet(num_nodes = 2, inp_dims = (2,4), oup_dims = (2,4), D=D) 
...
D = 3 # It should be 3.2 for \alpha = 1 for 8 spins with the decomposition [2, 4].
for j,rng in enumerate(rng_list):
    print("rng:", rng)
    res = simulate(rng, iterations, D=D)
    E_0 = res + 1.0382013707351838 #this energy is for 8 spins
...
np.savetxt('rlmpo_8_avg_d3_24_sr', E_0_aarray, header='Data for rlmpo with D = 3 for 3 different initializations')
