...
def simulate(rng, iterations, D):
    net = MyNet(num_nodes = 2, inp_dims = (4,3), oup_dims = (6,6), D=D) 
...
np.savetxt('rlmpo_12_avg_d8_66_gs', E_0_aarray, header='Data for rlmpo with D = 8 for 10 different initializations')
