...
def simulate(rng, iterations, D):
    net = MyNet(num_nodes = 2, inp_dims = (4,6), oup_dims = (7,7), D=D) 
...
for j,rng in enumerate(rng_list):
    print("rng:", rng)
    res = simulate(rng, iterations, D=16)
...
np.savetxt('rlmpo_24_avg_d16_77_gs', E_0_aarray, header='Data for rlmpo with D = 16 for 11 different initializations')
