...
def simulate(rng, iterations, D):
    net = MyNet(num_nodes = 2, inp_dims = (4,6), oup_dims = (12,12), D=D) 
...
for j,rng in enumerate(rng_list):
    print("rng:", rng)
    res = simulate(rng, iterations, D=9)
    E_0 = res + 1.0961572359081433 #this energy is for 12 spins
...
np.savetxt('rlmpo_24_avg_d9_1212_gs', E_0_aarray, header='Data for rlmpo with D = 9 for 11 different initializations')
