...
def simulate(rng, iterations, D, t_step = 5e-2): #Original t = 1e-2
...
for j,rng in enumerate(rng_list):
    print("rng:", rng)
    res = simulate(rng, iterations, D=D, t_step = time_step)
...
np.savetxt('cpxmpo_12_avg_d8_43_sr_1t', E_0_aarray, header='Data for cpxmpo with D = 8 for 1 initializations')
