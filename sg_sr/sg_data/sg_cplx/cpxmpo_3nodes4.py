...
net = MyNet(num_nodes = 3, inp_dims = (2,3,2), oup_dims = (4,3,3), D=4) 
...
for j,rng in enumerate(rng_list):
    print("rng:", rng)
    res = simulate(rng, iterations, D=4)
...
np.savetxt('cpxmpo_12_avg_d4_232_gs', E_0_aarray, header='Data for rlmpo with D = 4 for 10 different initializations')
